...
v5.11.9(uci): changes since 5.11.9(xboard):
UCI protocol with basic commands.
...
v5.11.5: changes since 5.11.4:
Refactor rays in move generation and evaluation
...
v5.11.0: changes since 5.10.5:
Best changes from v5.10.x.

v5.10.5: changes since 5.10.0:
Minor adaptions.

v5.10.0: changes since 5.9.9:
...
v5.9.5: changes since 5.9.4:
Singular extensions.

v5.9.4: changes since 5.9.3:
Refactor see. Simplify eval.

v5.9.3: changes since 5.9.2:
Adapt k-mobility. Endgame-factor adjustment.
...
MvvLva. Refactoring. Alignment in makefile.

v5.8.4: changes since 5.8.3:
Adapt King attack and null move pruning.
